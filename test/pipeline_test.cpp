...
SCENARIO("pipeline:test:heatmap", "[pipeline]")
{
  ...
  GIVEN("A specific initial condition")
  {
    ...
    {
      auto results   = getAnalyze(controller->getJobInformation().resultsFilePath);
      ...
      THEN("Check the measured data for the channels")
      {
        ...
        {
          {
            auto table = joda::db::StatsPerPlate::toHeatmap(joda::db::QueryFilter{
                .analyzer           = results.get(),
                .plateRows          = 16,
                .plateCols          = 24,
                .plateId            = 0,
                .actGroupId         = 0,
                .actImageId         = 0,
                .clusterId          = joda::enums::ClasssId::A,
        ...
        {
          {
            auto table = joda::db::StatsPerPlate::toHeatmap(joda::db::QueryFilter{
                ...
                .actGroupId         = 0,
                .actImageId         = 0,
                .clusterId          = joda::enums::ClasssId::B,
                .classId            = joda::enums::ClassId::C0,
                .className          = "",
                .measurementChannel = joda::enums::Measurement::CONFIDENCE,
                .stats              = joda::enums::Stats::CNT,
        ...
        {
          {
            auto table = joda::db::StatsPerPlate::toHeatmap(joda::db::QueryFilter{
                ...
                .actGroupId         = 0,
                .actImageId         = 0,
                .clusterId          = joda::enums::ClasssId::C,
                .classId            = joda::enums::ClassId::C0,
                .className          = "",
                .measurementChannel = joda::enums::Measurement::CONFIDENCE,
                .stats              = joda::enums::Stats::CNT,
        ...
        {
          {
            auto table = joda::db::StatsPerPlate::toHeatmap(joda::db::QueryFilter{
                ...
                .actGroupId         = 0,
                .actImageId         = 0,
                .clusterId          = joda::enums::ClasssId::D,
                .classId            = joda::enums::ClassId::C0,
                .className          = "",
                .measurementChannel = joda::enums::Measurement::CONFIDENCE,
                .stats              = joda::enums::Stats::CNT,
        ...
        {
          {
            auto table = joda::db::StatsPerPlate::toHeatmap(joda::db::QueryFilter{
                ...
                .actGroupId         = 0,
                .actImageId         = 0,
                .clusterId          = joda::enums::ClasssId::F,
                .classId            = joda::enums::ClassId::C0,
                .className          = "",
                .measurementChannel = joda::enums::Measurement::CONFIDENCE,
                .stats              = joda::enums::Stats::CNT,
...
std::optional<std::string> clusterToString(enums::ClasssId cl)
{
  switch(cl) {
    case enums::ClasssId::A:
      return "A";
    case enums::ClasssId::B:
      return "B";
    case enums::ClasssId::C:
      return "C";
    case enums::ClasssId::D:
      return "D";
    case enums::ClasssId::E:
      return "E";
    case enums::ClasssId::F:
      return "F";
    case enums::ClasssId::G:
      return "G";
    case enums::ClasssId::H:
      return "H";
    case enums::ClasssId::I:
      return "I";
    case enums::ClasssId::J:
      return "J";
    case enums::ClasssId::K:
      return "K";
    case enums::ClasssId::L:
      return "L";
    case enums::ClasssId::M:
      return "M";
    case enums::ClasssId::N:
      return "N";
    case enums::ClasssId::O:
      return "O";
    case enums::ClasssId::P:
      return "P";
    case enums::ClasssId::Q:
      return "Q";
    case enums::ClasssId::NONE:
      return "NONE";
    case enums::ClasssId::UNDEFINED:
      return "UNDEFINED";
...
void generateTestingCode(joda::db::Database *results)
{
  std::set<joda::enums::ClasssId> channels;
  channels.emplace(joda::enums::ClasssId::A);
  channels.emplace(joda::enums::ClasssId::B);
  channels.emplace(joda::enums::ClasssId::C);
  channels.emplace(joda::enums::ClasssId::D);
  channels.emplace(joda::enums::ClasssId::E);
  channels.emplace(joda::enums::ClasssId::F);

  std::stringstream str;

  for(joda::enums::ClasssId clusterId : channels) {
    for(int i = 1; i < 14; i++) {
      auto measure = (joda::enums::Measurement) i;

      str << "THEN(\"Check the " + toString(measure) + " for " + std::to_string((uint16_t) clusterId) + " data\")\n";
      str << "{\n";
      for(int s = 1; s <= 7; s++) {
        auto stats = (joda::enums::Stats) s;

        auto meChannel = [&measure, &stats, &results, &str, &clusterId](uint16_t channelId, joda::enums::ClasssId crossChannelClasss) {
          auto table = joda::db::StatsPerPlate::toHeatmap(joda::db::QueryFilter{
              .analyzer           = results,
              .plateRows          = 16,
              .plateCols          = 24,
              ...
              .classId            = joda::enums::ClassId::C0,
              .className          = "",
              .measurementChannel = measure,
              .stats              = stats,
              .crossChanelStack_c = channelId,
          });

          std::string clusterName = clusterToString(crossChannelClasss).value();

          if(!std::isnan(table.data(0, 9).getVal()) || !std::isnan(table.data(1, 9).getVal())) {
            str << "{\n";
            str << "auto table = joda::db::StatsPerPlate::toHeatmap(\n";
            str << "joda::db::QueryFilter{.analyzer              = results.get(),\n";
            str << "                      .plateRows             = 16,\n";
            str << "                      .plateCols             = 24,\n";
            str << "                      .plateId               = 0,\n";
            str << "                      .actGroupId            = 0,\n";
            str << "                      .actImageId            = 0,\n";
            str << "                      .clusterId             = joda::enums::ClasssId::" + (std::string) magic_enum::enum_name(clusterId) + ",\n";
            str << "                      .classId               = joda::enums::ClassId::C0,\n";
            str << "                      .className             = \"\",\n";
            str << "                      .measurementChannel    = joda::enums::Measurement::" + (std::string) magic_enum::enum_name(measure) + ",\n";
            str << "                      .stats                 = joda::enums::Stats::" + (std::string) magic_enum::enum_name(stats) + ",\n";
            str << "                      .crossChanelStack_c    = " + std::to_string(channelId) + ",\n";
            str << "                      .crossChannelClasssId = joda::enums::ClasssId::" + clusterName + ",\n";
            str << "                      });";
            str << "\n";

            if(!std::isnan(table.data(0, 9).getVal())) {
              str << "CHECK_THAT(table.data(0, 9).getVal(), Catch::Matchers::WithinAbs(" << std::fixed << std::setprecision(4)
                  << table.data(0, 9).getVal() << ", 0.0001));\n";
            }
            if(!std::isnan(table.data(1, 9).getVal())) {
              str << "CHECK_THAT(table.data(1, 9).getVal(), Catch::Matchers::WithinAbs(" << std::fixed << std::setprecision(4)
                  << table.data(1, 9).getVal() << ", 0.0001));\n";
            }
            str << "}\n";
          }
        };

        if(measure == joda::enums::Measurement::INTENSITY_SUM || measure == joda::enums::Measurement::INTENSITY_AVG ||
           measure == joda::enums::Measurement::INTENSITY_MAX || measure == joda::enums::Measurement::INTENSITY_MIN) {
          for(int me = 0; me < 2; me++) {
            meChannel(me, enums::ClasssId::NONE);
          }
        } else {
          meChannel(0, enums::ClasssId::NONE);
        }
      }
      str << "}\n";
    }
