...
std::optional<std::string> clusterToString(enums::ClusterId cl)
{
  switch(cl) {
    case enums::ClusterId::A:
      return "A";
    case enums::ClusterId::B:
      return "B";
    case enums::ClusterId::C:
      return "C";
    case enums::ClusterId::D:
      return "D";
    case enums::ClusterId::E:
      return "E";
    case enums::ClusterId::F:
      return "F";
    case enums::ClusterId::G:
      return "G";
    case enums::ClusterId::H:
      return "H";
    case enums::ClusterId::I:
      return "I";
    case enums::ClusterId::J:
      return "J";
    case enums::ClusterId::K:
      return "K";
    case enums::ClusterId::L:
      return "L";
    case enums::ClusterId::M:
      return "M";
    case enums::ClusterId::N:
      return "N";
    case enums::ClusterId::O:
      return "O";
    case enums::ClusterId::P:
      return "P";
    case enums::ClusterId::Q:
      return "Q";
    case enums::ClusterId::NONE:
      return "NONE";
    case enums::ClusterId::UNDEFINED:
      return "UNDEFINED";
...
void generateTestingCode(joda::db::Database *results)
{
  std::set<joda::enums::ClusterId> channels;
  channels.emplace(joda::enums::ClusterId::A);
  channels.emplace(joda::enums::ClusterId::B);
  channels.emplace(joda::enums::ClusterId::C);
  channels.emplace(joda::enums::ClusterId::D);
  channels.emplace(joda::enums::ClusterId::E);
  channels.emplace(joda::enums::ClusterId::F);

  std::stringstream str;

  for(joda::enums::ClusterId clusterId : channels) {
    for(int i = 1; i < 14; i++) {
      ...
      for(int s = 1; s <= 7; s++) {
        ...
        auto meChannel = [&measure, &stats, &results, &str, &clusterId](uint16_t channelId, joda::enums::ClusterId crossChannelCluster) {
          auto table = joda::db::StatsPerPlate::toHeatmap(joda::db::QueryFilter{
              .analyzer           = results,
              .plateRows          = 16,
              .plateCols          = 24,
          ...
          std::string clusterName = clusterToString(crossChannelCluster).value();
          ...
          if(!std::isnan(table.data(0, 9).getVal()) || !std::isnan(table.data(1, 9).getVal())) {
            ...
            str << "                      .actGroupId            = 0,\n";
            str << "                      .actImageId            = 0,\n";
            str << "                      .clusterId             = joda::enums::ClusterId::" + (std::string) magic_enum::enum_name(clusterId) + ",\n";
            ...
            str << "                      .crossChannelClusterId = joda::enums::ClusterId::" + clusterName + ",\n";
            str << "                      });";
            str << "\n";
        ...
        if(measure == joda::enums::Measurement::INTENSITY_SUM || measure == joda::enums::Measurement::INTENSITY_AVG ||
          ...
          for(int me = 0; me < 2; me++) {
            meChannel(me, enums::ClusterId::NONE);
          }
        } else {
          meChannel(0, enums::ClusterId::NONE);
        }
      }
      str << "}\n";
    }
