  ...
  for(joda::enums::ClusterId clusterId : channels) {
    for(int i = 1; i < 14; i++) {
      ...
      for(int s = 1; s <= 7; s++) {
        ...
        auto meChannel = [&measure, &stats, &results, &str, &clusterId](uint16_t channelId,
                                                                        joda::enums::ClusterId crossChannelCluster) {
          auto table = joda::db::StatsPerPlate::toHeatmap(
              joda::db::QueryFilter{.analyzer              = results,
                                    .plateRows             = 16,
                                    .plateCols             = 24,
                                    .plateId               = 0,
                                    .actGroupId            = 0,
                                    ...
                                    .crossChannelClusterId = crossChannelCluster,
                                    .crossChannelClassId   = joda::enums::ClassId::C0});
          ...
          if(!std::isnan(table.data(0, 9).getVal()) || !std::isnan(table.data(1, 9).getVal())) {
            ...
            str << "                      .actGroupId            = 0,\n";
            str << "                      .actImageId            = 0,\n";
            str << "                      .clusterId             = joda::enums::ClusterId::" +
                       (std::string) magic_enum::enum_name(clusterId) + ",\n";
            str << "                      .classId               = joda::enums::ClassId::C0,\n";
            str << "                      .className             = \"\",\n";
            str << "                      .measurementChannel    = joda::enums::Measurement::" +
                       (std::string) magic_enum::enum_name(measure) + ",\n";
            str << "                      .stats                 = joda::enums::Stats::" +
                       (std::string) magic_enum::enum_name(stats) + ",\n";
            str << "                      .crossChanelStack_c    = " + std::to_string(channelId) + ",\n";
            str << "                      .crossChannelClusterId = joda::enums::ClusterId::" + clusterName + ",\n";
            str << "                      .crossChannelClassId   = joda::enums::ClassId::C0});";
            str << "\n";
        ...
        if(measure == joda::enums::Measurement::INTERSECTING_CNT) {
          for(int me = 0; me < 2; me++) {
            meChannel(0, (enums::ClusterId) me);
          }
        } else if(measure == joda::enums::Measurement::INTENSITY_SUM ||
                  measure == joda::enums::Measurement::INTENSITY_AVG ||
                  measure == joda::enums::Measurement::INTENSITY_MAX ||
                  measure == joda::enums::Measurement::INTENSITY_MIN) {
          for(int me = 0; me < 2; me++) {
