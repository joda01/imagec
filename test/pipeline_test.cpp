        ...
        {
          {
            auto table = joda::db::StatsPerPlate::toHeatmap(
                joda::db::QueryFilter{.analyzer              = results.get(),
                                      ...
                                      .crossChannelClusterId = joda::enums::ClusterId::A,
        ...
        {
          {
            auto table = joda::db::StatsPerPlate::toHeatmap(
                joda::db::QueryFilter{.analyzer              = results.get(),
                                      ...
                                      .classId               = joda::enums::ClassId::C0,
                                      .className             = "",
                                      .measurementChannel    = joda::enums::Measurement::COUNT,
                                      .stats                 = joda::enums::Stats::AVG,
                                      .crossChanelStack_c    = 0,
                                      .crossChannelClusterId = joda::enums::ClusterId::A,
                                      .crossChannelClassId   = joda::enums::ClassId::C0});
        ...
        {
          {
            auto table = joda::db::StatsPerPlate::toHeatmap(
                joda::db::QueryFilter{.analyzer              = results.get(),
                                      ...
                                      .actImageId            = 0,
                                      .clusterId             = joda::enums::ClusterId::A,
                                      .classId               = joda::enums::ClassId::NONE,
                                      .className             = "",
                                      .measurementChannel    = joda::enums::Measurement::COUNT,
                                      .stats                 = joda::enums::Stats::AVG,
                                      .crossChanelStack_c    = 0,
          ...
          }
          {
            auto table = joda::db::StatsPerPlate::toHeatmap(
                joda::db::QueryFilter{.analyzer              = results.get(),
                                      ...
                                      .crossChannelClusterId = joda::enums::ClusterId::B,
                                      .crossChannelClassId   = joda::enums::ClassId::C0});
        ...
        {
          {
            auto table = joda::db::StatsPerPlate::toHeatmap(
                joda::db::QueryFilter{.analyzer              = results.get(),
                                      ...
                                      .classId               = joda::enums::ClassId::C0,
                                      .className             = "",
                                      .measurementChannel    = joda::enums::Measurement::INTERSECTING_CNT,
                                      .stats                 = joda::enums::Stats::AVG,
                                      .crossChanelStack_c    = 0,
                                      .crossChannelClusterId = joda::enums::ClusterId::A,
                                      .crossChannelClassId   = joda::enums::ClassId::C0});
        ...
        {
          {
            auto table = joda::db::StatsPerPlate::toHeatmap(
                joda::db::QueryFilter{.analyzer              = results.get(),
                                      ...
                                      .actGroupId            = 0,
                                      .actImageId            = 0,
                                      .clusterId             = joda::enums::ClusterId::E,
                                      .classId               = joda::enums::ClassId::C0,
                                      .className             = "",
                                      .measurementChannel    = joda::enums::Measurement::CONFIDENCE,
                                      .stats                 = joda::enums::Stats::AVG,
      ...
      for(int s = 0; s < 6; s++) {
        ...
        auto meChannel = [&measure, &stats, &results, &str, &channelIdx](joda::results::ChannelIndex meE) {
          auto table = joda::db::StatsPerPlate::toHeatmap(joda::db::QueryFilter {
            .analyzer = results, .plateRows = 16, .plateCols = 24, .plateId = 0, .actGroupId = 0, .actImageId = 0,
            .clusterId = channelIdx, .classId = joda::enums::ClassId::C0, .className = "",
            .measurementChannel = {
              measure, .stats = stats, .crossChanelStack_c = meE, .crossChannelClusterId = meE,
              .joda::enums::ClassId crossChannelClassId;
            = joda::enums::ClassId::C0
          });
          ...
          if(!std::isnan(table.data(0, 9).getVal()) || !std::isnan(table.data(1, 9).getVal())) {
            ...
            str << "auto table = joda::db::StatsPerPlate::toHeatmap(*results, 1, 16, 24, "
                   "joda::results::ChannelIndex::" +
                       toString(channelIdx) + ",joda::enums::Measurement::" + toString(measure) +
                       ", "
                       "joda::results::ChannelIndex::" +
                       toString(meE) + "}, joda::enums::Stats::" + toString(stats) + ");\n";
        ...
        if(measure == joda::enums::Measurement::INTERSECTING_CNT ||
           measure == joda::enums::Measurement::INTENSITY_AVG || measure == joda::enums::Measurement::INTENSITY_MAX ||
