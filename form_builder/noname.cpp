...
frameMain::frameMain( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxFrame( parent, id, title, pos, size, style )
{
	...
	mButtonSave = mToolBar->AddTool( wxID_ANY, _("Save"), icons8-save-20_png_to_wx_bitmap(), wxNullBitmap, wxITEM_NORMAL, wxEmptyString, wxEmptyString, NULL );

	mButtonOpen = mToolBar->AddTool( wxID_ANY, _("Open"), icons8-opened-folder-20_png_to_wx_bitmap(), wxNullBitmap, wxITEM_NORMAL, wxEmptyString, wxEmptyString, NULL );
	...
	mButtonSelectWorkingDirectory = mToolBar->AddTool( wxID_ANY, _("Stop"), icons8-opened-folder-20_png_to_wx_bitmap(), wxNullBitmap, wxITEM_NORMAL, wxEmptyString, wxEmptyString, NULL );

	mButtonRun = mToolBar->AddTool( wxID_ANY, _("Start"), icons8-start-20_png_to_wx_bitmap(), wxNullBitmap, wxITEM_NORMAL, wxEmptyString, wxEmptyString, NULL );

	mToolBar->AddSeparator();

	mButtonSettings = mToolBar->AddTool( wxID_ANY, _("Settings"), icons8-settings-20_png_to_wx_bitmap(), wxNullBitmap, wxITEM_NORMAL, wxEmptyString, wxEmptyString, NULL );

	mButtonAbout = mToolBar->AddTool( wxID_ANY, _("Info"), icons8-info-20_png_to_wx_bitmap(), wxNullBitmap, wxITEM_NORMAL, wxEmptyString, wxEmptyString, NULL );
	...
	mPannelChannel = new wxScrolledWindow( mPanelChannel, wxID_ANY, wxDefaultPosition, wxSize( 250,-1 ), wxBORDER_NONE|wxVSCROLL );
	...
	mLabelChannelTitle = new wxStaticText( mPannelChannel, wxID_ANY, _("Channel"), wxDefaultPosition, wxDefaultSize, wxALIGN_CENTER_HORIZONTAL );
	...
	mLabelPreprocessing = new wxStaticText( mPannelChannel, wxID_ANY, _("Preprocessing"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	panelZStack = new wxPanel( mPannelChannel, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxBORDER_RAISED|wxTAB_TRAVERSAL );
	...
	iconZStack = new wxStaticBitmap( panelZStack, wxID_ANY, icons8-layers-20_png_to_wx_bitmap(), wxDefaultPosition, wxDefaultSize, 0 );
	...
	panelMarginCrop = new wxPanel( mPannelChannel, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxBORDER_RAISED|wxTAB_TRAVERSAL );
	...
	iconMarginCrop = new wxStaticBitmap( panelMarginCrop, wxID_ANY, icons8-crop-20_png_to_wx_bitmap(), wxDefaultPosition, wxDefaultSize, 0 );
	...
	panelMedianBGSubtract = new wxPanel( mPannelChannel, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxBORDER_RAISED|wxTAB_TRAVERSAL );
	...
	iconMedianBGSubtract = new wxStaticBitmap( panelMedianBGSubtract, wxID_ANY, icons8-electrical-threshold-20_png_to_wx_bitmap(), wxDefaultPosition, wxDefaultSize, 0 );
	...
	panelRollingBall = new wxPanel( mPannelChannel, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxBORDER_RAISED|wxTAB_TRAVERSAL );
	...
	iconRollingBall = new wxStaticBitmap( panelRollingBall, wxID_ANY, icons8-sphere-20_png_to_wx_bitmap(), wxDefaultPosition, wxDefaultSize, 0 );
	...
	panelBGSubtraction = new wxPanel( mPannelChannel, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxBORDER_RAISED|wxTAB_TRAVERSAL );
	...
	iconBGSubtraction = new wxStaticBitmap( panelBGSubtraction, wxID_ANY, icons8-background-remover-20_png_to_wx_bitmap(), wxDefaultPosition, wxDefaultSize, 0 );
	...
	panelBluer = new wxPanel( mPannelChannel, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxBORDER_RAISED|wxTAB_TRAVERSAL );
	...
	iconBluer = new wxStaticBitmap( panelBluer, wxID_ANY, icons8-blur-20_png_to_wx_bitmap(), wxDefaultPosition, wxDefaultSize, 0 );
	...
	panelUseAI = new wxPanel( mPannelChannel, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxBORDER_RAISED|wxTAB_TRAVERSAL );
	...
	iconUseAI = new wxStaticBitmap( panelUseAI, wxID_ANY, icons8-ai-20_png_to_wx_bitmap(), wxDefaultPosition, wxDefaultSize, 0 );
	...
	panelThresholdMethod = new wxPanel( mPannelChannel, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxBORDER_RAISED|wxTAB_TRAVERSAL );
	...
	iconThresholdMethod = new wxStaticBitmap( panelThresholdMethod, wxID_ANY, icons8-lambda-20_png_to_wx_bitmap(), wxDefaultPosition, wxDefaultSize, 0 );
	...
	panelMinThreshold = new wxPanel( mPannelChannel, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxBORDER_RAISED|wxTAB_TRAVERSAL );
	...
	iconMinThreshold = new wxStaticBitmap( panelMinThreshold, wxID_ANY, icons8-contrast-20_png_to_wx_bitmap(), wxDefaultPosition, wxDefaultSize, 0 );
	...
	panelMinCircularity = new wxPanel( mPannelChannel, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxBORDER_RAISED|wxTAB_TRAVERSAL );
	...
	iconMinCircularity = new wxStaticBitmap( panelMinCircularity, wxID_ANY, icons8-octagon-20_png_to_wx_bitmap(), wxDefaultPosition, wxDefaultSize, 0 );
	...
	panelParticleSize = new wxPanel( mPannelChannel, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxBORDER_RAISED|wxTAB_TRAVERSAL );
	...
	iDescription1121 = new wxStaticBitmap( panelParticleSize, wxID_ANY, icons8-all-out-20_png_to_wx_bitmap(), wxDefaultPosition, wxDefaultSize, 0 );
	...
	panelParticleSize111 = new wxPanel( mPannelChannel, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxBORDER_RAISED|wxTAB_TRAVERSAL );
	...
	iconParticleSize = new wxStaticBitmap( panelParticleSize111, wxID_ANY, icons8-centre-point-20_png_to_wx_bitmap(), wxDefaultPosition, wxDefaultSize, 0 );
	...
	iconNucluesChannel = new wxStaticBitmap( panelNucleusChannel, wxID_ANY, icons8-bursts-20_png_to_wx_bitmap(), wxDefaultPosition, wxDefaultSize, 0 );
	...
	iconMaxCellRadius = new wxStaticBitmap( panelMaxCellRadius, wxID_ANY, icons8-all-out-20_png_to_wx_bitmap(), wxDefaultPosition, wxDefaultSize, 0 );
	...
	iconTetraspeckChannel = new wxStaticBitmap( panelTetraspeckChannel, wxID_ANY, icons8-bursts-20_png_to_wx_bitmap(), wxDefaultPosition, wxDefaultSize, 0 );
...
dialogProcessing::dialogProcessing( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	iconCpuCores = new wxStaticBitmap( panelFooterButtons, wxID_ANY, icons8-cpu-20_png_to_wx_bitmap(), wxDefaultPosition, wxDefaultSize, 0 );
