...
/// \return
///
void ExporterXlsx::exportAsList(const joda::table::Table &table, std::string outputFileName)
{
...
/// \return
///
void ExporterXlsx::exportAsHeatmap(const joda::table::Table &table, std::string outputFileName)
{
  auto workbookSettings    = prepare(outputFileName);
  lxw_worksheet *worksheet = workbook_add_worksheet(workbookSettings.workbook, "results");
