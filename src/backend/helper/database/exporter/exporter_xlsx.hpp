...
public:
  /////////////////////////////////////////////////////
  static void exportAsList(const joda::table::Table &table, std::string outputFileName);
  static void exportAsHeatmap(const joda::table::Table &table, std::string outputFileName);
