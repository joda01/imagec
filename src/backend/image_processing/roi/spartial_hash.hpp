...
public:
  ...
  calcIntersections(const std::unique_ptr<detect::DetectionResults> &other,
                    const std::map<joda::settings::ChannelIndex, const cv::Mat *> &imageOriginal, float minIntersecion);
