...
public:
  ...
  RollingBallBackground(joda::settings::AnalyzeSettings *analyzeSettings, joda::settings::PipelineStep &pipelineStep,
                        settings::RollingBallSettings &settings, QWidget *parent) :
