...
class Laplacian : public Command
{
public:
  /////////////////////////////////////////////////////
  inline static std::string TITLE             = "Laplacian";
  inline static std::string ICON              = "function";
  inline static std::string DESCRIPTION       = "Reduce noise within the image";
  inline static std::vector<std::string> TAGS = {"laplacian"};
              ...
              {{InOuts::IMAGE, InOuts::BINARY}, {InOuts::IMAGE}})
  {
    ...
    addSetting({{mKernelSize.get(), true, 0}, {mRepeat.get(), true, 0}});
  }
