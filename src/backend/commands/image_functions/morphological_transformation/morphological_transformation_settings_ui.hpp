...
public:
  ...
  MorphologicalTransform(joda::settings::AnalyzeSettings *analyzeSettings, joda::settings::PipelineStep &pipelineStep,
                         settings::MorphologicalTransformSettings &settings, QWidget *parent) :
