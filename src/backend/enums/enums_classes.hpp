...
NLOHMANN_JSON_SERIALIZE_ENUM(ClassIdIn, {
                                            ...
                                            {ClassId::C33, "33"},        {ClassId::C34, "34"},
                                            {ClassId::C35, "35"},        {ClassId::C36, "36"},
                                            {ClassId::C37, "37"},        {ClassId::C38, "38"},
                                            {ClassId::C39, "39"},        {ClassId::C40, "40"},
                                            {ClassId::C41, "41"},        {ClassId::C42, "42"},
                                            {ClassId::C43, "43"},        {ClassId::C44, "44"},
                                            {ClassId::C45, "45"},        {ClassId::C46, "46"},
                                            {ClassId::C47, "47"},        {ClassId::C48, "48"},
                                            {ClassId::C49, "49"},        {ClassIdIn::TEMP_01, "M01"},
