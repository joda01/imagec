    ...
    wxFrame(parent, id, title, pos, size, style)
{
  ...
  mButtonSave = mToolBar->AddTool(wxID_ANY, _("Save"), save_20_png_to_wx_bitmap(), wxNullBitmap, wxITEM_NORMAL,
                                  wxEmptyString, wxEmptyString, NULL);

  mButtonOpen = mToolBar->AddTool(wxID_ANY, _("Open"), opened_folder_20_png_to_wx_bitmap(), wxNullBitmap, wxITEM_NORMAL,
                                  wxEmptyString, wxEmptyString, NULL);

  mToolBar->AddSeparator();

  mLabelNrOfFoundFiles =
      new wxStaticText(mToolBar, wxID_ANY, _("Images dir: "), wxDefaultPosition, wxDefaultSize, wxALIGN_LEFT);
  mLabelNrOfFoundFiles->Wrap(-1);
  mToolBar->AddControl(mLabelNrOfFoundFiles);
  mDirectoryPicker = new wxDirPickerCtrl(mToolBar, wxID_ANY, wxEmptyString, _("Select a folder"), wxDefaultPosition,
                                         wxSize(250, -1), wxDIRP_DEFAULT_STYLE | wxDIRP_DIR_MUST_EXIST);
  mToolBar->AddControl(mDirectoryPicker);
  mButtonRun = mToolBar->AddTool(wxID_ANY, _("Start"), start_20_png_to_wx_bitmap(), wxNullBitmap, wxITEM_NORMAL,
                                 wxEmptyString, wxEmptyString, NULL);

  mToolBar->AddSeparator();

  mButtonSettings = mToolBar->AddTool(wxID_ANY, _("Settings"), settings_20_png_to_wx_bitmap(), wxNullBitmap,
                                      wxITEM_NORMAL, wxEmptyString, wxEmptyString, NULL);

  mButtonAbout = mToolBar->AddTool(wxID_ANY, _("Info"), info_20_png_to_wx_bitmap(), wxNullBitmap, wxITEM_NORMAL,
                                   wxEmptyString, wxEmptyString, NULL);
  ...
  iconNucluesChannel = new wxStaticBitmap(panelNucleusChannel, wxID_ANY, bursts_20_png_to_wx_bitmap(),
  ...
  iconMaxCellRadius = new wxStaticBitmap(panelMaxCellRadius, wxID_ANY, all_out_20_png_to_wx_bitmap(), wxDefaultPosition,
                                         wxDefaultSize, 0);
  sizerMaxCellRadius2->Add(iconMaxCellRadius, 0,
                           wxALIGN_CENTER | wxALIGN_CENTER_HORIZONTAL | wxALIGN_TOP | wxLEFT | wxRIGHT, 5);

  mSpinMaxCellRadius = new wxSpinCtrl(panelMaxCellRadius, wxID_ANY, wxT("0.000000"), wxDefaultPosition, wxDefaultSize,
                                      wxSP_ARROW_KEYS, 0, 100, 0.000000);
  ...
  mLabelMaxCellRadius = new wxStaticText(panelMaxCellRadius, wxID_ANY, _("Maximum cell radius [px2]"),
  ...
  panelTetraspeckChannel =
      new wxPanel(mPanelSpotRemoval, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxBORDER_THEME | wxTAB_TRAVERSAL);
  ...
  iconTetraspeckChannel = new wxStaticBitmap(panelTetraspeckChannel, wxID_ANY, bursts_20_png_to_wx_bitmap(),
                                             wxDefaultPosition, wxDefaultSize, 0);
  ...
  mButtonAddChannel->Connect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(frameMain::onAddChannelClicked), NULL,
                             this);
}
...
frameMain::~frameMain()
{
  ...
  mButtonAddChannel->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(frameMain::onAddChannelClicked),
                                NULL, this);
}
    ...
    wxDialog(parent, id, title, pos, size, style)
{
  ...
  iconCpuCores =
      new wxStaticBitmap(panelFooterButtons, wxID_ANY, cpu_20_png_to_wx_bitmap(), wxDefaultPosition, wxDefaultSize, 0);
  sizerFooterButtons2->Add(iconCpuCores, 0, wxALIGN_CENTER | wxALIGN_CENTER_HORIZONTAL | wxALIGN_TOP | wxLEFT | wxRIGHT,
                           5);

  mSpinCpuCores = new wxSpinCtrl(panelFooterButtons, wxID_ANY, wxT("1"), wxDefaultPosition, wxDefaultSize,
...
PanelChannel::PanelChannel(wxWindow *parent, wxWindowID id, const wxPoint &pos, const wxSize &size, long style,
                           const wxString &name) :
    wxPanel(parent, id, pos, size, style, name)
{
  ...
  mScrolledChannel =
      new wxScrolledWindow(this, wxID_ANY, wxDefaultPosition, wxSize(250, -1), wxBORDER_NONE | wxVSCROLL);
  ...
  mLabelChannelTitle = new wxStaticText(mScrolledChannel, wxID_ANY, _("Channel"), wxDefaultPosition, wxDefaultSize,
                                        wxALIGN_CENTER_HORIZONTAL);
  ...
  mLabelPreprocessing =
      new wxStaticText(mScrolledChannel, wxID_ANY, _("Preprocessing"), wxDefaultPosition, wxDefaultSize, 0);
  ...
  panelZStack =
      new wxPanel(mScrolledChannel, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxBORDER_THEME | wxTAB_TRAVERSAL);
  ...
  iconZStack =
      new wxStaticBitmap(panelZStack, wxID_ANY, layers_20_png_to_wx_bitmap(), wxDefaultPosition, wxDefaultSize, 0);
  ...
  iconMarginCrop =
      new wxStaticBitmap(panelMarginCrop, wxID_ANY, crop_20_png_to_wx_bitmap(), wxDefaultPosition, wxDefaultSize, 0);
  sizerMarginCrop2->Add(iconMarginCrop, 0, wxALIGN_CENTER | wxALIGN_CENTER_HORIZONTAL | wxALIGN_TOP | wxLEFT | wxRIGHT,
                        5);

  mSpinMarginCrop = new wxSpinCtrl(panelMarginCrop, wxID_ANY, wxT("0.000000"), wxDefaultPosition, wxDefaultSize,
                                   wxSP_ARROW_KEYS, 0, 65535, 0.000000);
  ...
  iconMedianBGSubtract = new wxStaticBitmap(panelMedianBGSubtract, wxID_ANY, electrical_threshold_20_png_to_wx_bitmap(),
                                            wxDefaultPosition, wxDefaultSize, 0);
  ...
  iconRollingBall =
      new wxStaticBitmap(panelRollingBall, wxID_ANY, sphere_20_png_to_wx_bitmap(), wxDefaultPosition, wxDefaultSize, 0);
  sizerRollingBall2->Add(iconRollingBall, 0,
                         wxALIGN_CENTER | wxALIGN_CENTER_HORIZONTAL | wxALIGN_TOP | wxLEFT | wxRIGHT, 5);

  mSpinRollingBall = new wxSpinCtrl(panelRollingBall, wxID_ANY, wxT("0"), wxDefaultPosition, wxDefaultSize,
                                    wxSP_ARROW_KEYS, 0, 256, 0);
  ...
  iconBGSubtraction = new wxStaticBitmap(panelBGSubtraction, wxID_ANY, background_remover_20_png_to_wx_bitmap(),
                                         wxDefaultPosition, wxDefaultSize, 0);
  ...
  mSpinBluer =
      new wxSpinCtrl(panelBluer, wxID_ANY, wxT("0"), wxDefaultPosition, wxDefaultSize, wxSP_ARROW_KEYS, 0, 128, 0);
  ...
  iconThresholdMethod = new wxStaticBitmap(panelThresholdMethod, wxID_ANY, formula_fx_20_png_to_wx_bitmap(),
                                           wxDefaultPosition, wxDefaultSize, 0);
  ...
  iconMinThreshold = new wxStaticBitmap(panelMinThreshold, wxID_ANY, contrast_20_png_to_wx_bitmap(), wxDefaultPosition,
                                        wxDefaultSize, 0);
  sizerMinThreshold2->Add(iconMinThreshold, 0,
                          wxALIGN_CENTER | wxALIGN_CENTER_HORIZONTAL | wxALIGN_TOP | wxLEFT | wxRIGHT, 5);

  mSpinMinThreshold = new wxSpinCtrl(panelMinThreshold, wxID_ANY, wxT("0"), wxDefaultPosition, wxDefaultSize,
  ...
  iconMinCircularity = new wxStaticBitmap(panelMinCircularity, wxID_ANY, octagon_20_png_to_wx_bitmap(),
                                          wxDefaultPosition, wxDefaultSize, 0);
  ...
  mSpinMinCircularity = new wxSpinCtrlDouble(panelMinCircularity, wxID_ANY, wxEmptyString, wxDefaultPosition,
                                             wxDefaultSize, wxSP_ARROW_KEYS, 0, 1, 0.000000, 0.01);
  ...
  panelParticleSize =
      new wxPanel(mScrolledChannel, wxID_ANY, wxDefaultPosition, wxSize(-1, -1), wxBORDER_THEME | wxTAB_TRAVERSAL);
  ...
  iDescription1121 = new wxStaticBitmap(panelParticleSize, wxID_ANY, all_out_20_png_to_wx_bitmap(), wxDefaultPosition,
                                        wxDefaultSize, 0);
  sizerParticleSize2->Add(iDescription1121, 0,
                          wxALIGN_CENTER | wxALIGN_CENTER_HORIZONTAL | wxALIGN_TOP | wxLEFT | wxRIGHT, 5);

  mTextParticleSizeRange =
      new wxTextCtrl(panelParticleSize, wxID_ANY, _("5-9999"), wxDefaultPosition, wxDefaultSize, 0);
  ...
  mLabelParticleSize = new wxStaticText(panelParticleSize, wxID_ANY, _("Particle size range [px2]"), wxDefaultPosition,
                                        wxDefaultSize, wxALIGN_LEFT);
  ...
  iconParticleSize = new wxStaticBitmap(panelSnapArea, wxID_ANY, centre_point_20_png_to_wx_bitmap(), wxDefaultPosition,
                                        wxDefaultSize, 0);
  sizerSnapArea2->Add(iconParticleSize, 0, wxALIGN_CENTER | wxALIGN_CENTER_HORIZONTAL | wxALIGN_TOP | wxLEFT | wxRIGHT,
                      5);

  mSpinSnapArea =
      new wxSpinCtrl(panelSnapArea, wxID_ANY, wxT("0"), wxDefaultPosition, wxDefaultSize, wxSP_ARROW_KEYS, 0, 256, 0);
  ...
  mLabelSnapArea = new wxStaticText(panelSnapArea, wxID_ANY, _("Snap area diamater [px2]"), wxDefaultPosition,
                                    wxDefaultSize, wxALIGN_LEFT);
  mLabelSnapArea->Wrap(-1);
  mLabelSnapArea->SetFont(
      wxFont(8, wxFONTFAMILY_DEFAULT, wxFONTSTYLE_ITALIC, wxFONTWEIGHT_NORMAL, false, wxEmptyString));
