...
private:
  ...
  wxPoint mPositionOffsetToCenter = {0, 0};
};
...
public:
  ...
  DialogImageController(wxWindow *parent, wxWindowID id = wxID_ANY, const wxString &title = wxEmptyString,
                        ...
                        long style = wxCAPTION | wxCLOSE_BOX | wxRESIZE_BORDER | wxMAXIMIZE);
  ...
  void updateImage(const wxImage &image, const std::string &imageFileName, int tileNr, const SmallStatistics &result);
