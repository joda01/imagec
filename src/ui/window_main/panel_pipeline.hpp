...
template <class T>
concept channel_setting_t = std::is_base_of<joda::settings::ChannelSettings, T>::value ||
                            std::is_base_of<joda::settings::VChannelIntersection, T>::value ||
                            std::is_base_of<joda::settings::VChannelVoronoi, T>::value;

template <class T>
concept channel_container_t = std::is_base_of<joda::ui::qt::ContainerBase, T>::value;
