...
PanelGraphSettings::PanelGraphSettings(QWidget *parent) : QDockWidget(parent)
{
...

  {
    ...
    // Plate settings
    {
      ...
      connect(openPlateSettings, &QPushButton::clicked, [this] {
        auto *dialogPlateSettings = new DialogPlateSettings(&mWellImageOrder, parentWidget());
